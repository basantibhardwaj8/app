...
import { signOut } from 'firebase/auth'; // Adjust this import if necessary

import img1 from '../../assets/hlo.jpeg'; // Ensure this path is correct

const Dashboard = () => {
  const history = useNavigate(); // Using useNavigate for routing
  ...
  return (
    <div className='dashboard-wrapper'>
      <div className='side-nav'>
        <div className='profile-info'>
          <img src={img1} alt="Profile" /> {/* Display static image */}
          <div>
            <p>{localStorage.getItem('cname')}</p> {/* Display user name */}
