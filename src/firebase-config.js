...
//   const fileRef = ref(storage, `profiles/${auth.currentUser.uid}/profile.jpg`); // Use backticks here
//   const uploadTask = uploadBytesResumable(fileRef, file);
...
// export { app, auth, db, storage, updateProfile, updateProfilePicture };
